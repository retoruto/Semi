...
bool SemiService:: userLogIn(const std::string &userName, const std::string &password){
...
bool SemiService:: userRegister(const std::string &userName, const std::string &password,
...
bool SemiService:: deleteUser(const std::string &userName, const std::string &password){
...
std::list<User> SemiService:: listAllUsers(void) const{
    std::list<User> ret;
...
bool SemiService:: createMeeting(const std::string &userName, const std::string &title,
...
bool SemiService:: addMeetingParticipator(const std::string &userName,
...
bool SemiService:: removeMeetingParticipator(const std::string &userName,
                                 const std::string &title,
                                 const std::string &participator){
...
bool SemiService:: quitMeeting(const std::string &userName, const std::string &title){
    int ret = m_storage->updateMeeting([&](const Meeting& m){
...
std::list<Meeting> SemiService:: meetingQuery(const std::string &userName,
...
std::list<Meeting> SemiService:: listAllMeetings(const std::string &userName) const{
...
std::list<Meeting> SemiService:: listAllSponsorMeetings(const std::string &userName) const{
...
std::list<Meeting> SemiService:: listAllParticipateMeetings(
...
bool SemiService:: deleteMeeting(const std::string &userName, const std::string &title){
...
bool SemiService:: deleteAllMeetings(const std::string &userName){
    m_storage->deleteMeeting([&](const Meeting &m){return m.getSponsor() == userName;});
    return true;
};

void SemiService:: startSemi(void){
    m_storage = Storage::getInstance();
};

void SemiService:: quitSemi(void){
    m_storage->sync();
};
